...
public class ParallelizedCountingSort {
    ...
    public static void hideSort() {
        ...
        System.out.println("La verificación exhaustiva del array devolvió " + isSorted(output, N_ITEMS));
    }
	 ...
	 * de salida y al array de conteo, y el tamaño del array.
	 * 
	 * @param array  El array a ordenar.
	 * @param output El array donde se ordenarán los elementos.
